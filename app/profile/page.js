...
export default function Profile() {
  ...
  return (
    <main className="min-h-screen py-20 px-4">
      {/* Toast */}
      <div className="fixed top-9 right-6 z-[9999] pointer-events-none">
        <div
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="flex-1 w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 outline-none focus:ring-2 focus:ring-black focus:border-black transition cursor-text"
                      value={firstName}
                ...
                <div className="mt-8 flex justify-end">
                  <button
                    onClick={handleSave}
                    className="inline-flex items-center justify-center rounded-xl bg-black text-white px-6 py-3 font-medium hover:bg-gray-800 transition shadow-md cursor-pointer"
                  >
                    Save Changes
                  </button>
                </div>
